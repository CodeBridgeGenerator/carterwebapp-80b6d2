...
describe("voucher service", async () => {
  ...
  describe("#create", () => {
    const options = {"category_id":`${categoryCreated._id}`,"name":"new value","title":"new value","description":"new value","points":23,"image":"new value"};
...
assert.strictEqual(voucherCreated.image, options.image);
  ...
  describe("#update", () => {
    const options = {"category_id":`${categoryCreated._id}`,"title":"updated value","description":"updated value","points":100,"image":"updated value"};
