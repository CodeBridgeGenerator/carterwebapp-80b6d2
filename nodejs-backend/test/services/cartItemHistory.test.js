...
const voucherCreated = await app.service("voucher").Model.create({"user":`${userCreated._id}`,"email":"new value","username":"new value","password":"new value","is_active":true,"points":23,"voucher":"parentObjectId","category_id":`${categoryCreated._id}`,"name":"new value","title":"new value","description":"new value","image":"new value"});
  ...
  describe("#create", () => {
    const options = {"user":`${userCreated._id}`,"email":"new value","username":"new value","password":"new value","is_active":true,"points":23,"voucher":`${voucherCreated._id}`,"category_id":`${categoryCreated._id}`,"name":"new value","title":"new value","description":"new value","image":"new value","quantity":23,"timestamp":"2026-06-06T07:29:04.930Z"};
...
assert.strictEqual(cartItemHistoryCreated.timestamp.toISOString(), options.timestamp);
  ...
  describe("#update", () => {
    const options = {"user":`${userCreated._id}`,"voucher":`${voucherCreated._id}`,"quantity":100,"timestamp":"2026-06-06T07:29:04.930Z"};
