...
const inputNameTemplate0 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="name" header="Category Name" body={inputNameTemplate0} filter={selectedFilterFields.includes("name")} hidden={selectedHideFields?.includes("name")}  sortable  style={{ minWidth: "8rem" }} />
