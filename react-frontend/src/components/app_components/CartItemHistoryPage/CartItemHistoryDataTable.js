...
<Column field="timestamp" header="Timestamp" body={datetimeTimestampTemplate3} filter={selectedFilterFields.includes("timestamp")} hidden={selectedHideFields?.includes("timestamp")}  sortable  style={{ minWidth: "8rem" }} />
